...
class MyScrapListScreen extends React.Component {
    ...
    constructor(props) {
        ...
        didBlurSubscription = this.props.navigation.addListener(
            ...
            async payload => {
                ...
                await MyInfoActions.pageListPostsByIsScrap(this.props.orderby, this.props.postsList.length / 7, 7);
    ...
    pageListScraps = async () => {
        ...
        await MyInfoActions.pageListPostsByIsScrap(this.props.orderby, this.props.postsList.length / 7 + 1, 7);
            ...
            <SafeAreaView style={styles.container}>
                {
                    this.props.myPost_loading == true ?
                        ...
                        <FlatList
                            ...
                            onEndReached={() => {this.props.postsList.length < this.props.total ? this.pageListScraps() : null;}}
