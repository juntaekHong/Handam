    ...
    certification_Check = async () => {
        ...
        let timeout = setInterval(async () => {
            if (
                ...
                this.props.hansunginfo.status == "UNVERIFIED" && this.state.certCheck == true
            ) {
                await HansungInfoActions.getHansungInfo();
        ...
        <SafeAreaView>
          <ScrollView>
            <CustomModal
                width={295}
                height={311}
                children={<CustomModalBlackText>인증을 삭제하시겠습니까?</CustomModalBlackText>}
            ...
            <CustomModal
                width={295}
                height={311}
                children={<CustomModalBlackText> 로그아웃 하시겠습니까?</CustomModalBlackText>}
            ...
            <AccountDetailView>
              ...
              >
                <TouchableOpacity onPress={() => {this.navigateMyPost()}}>
                  <AccountDetailText>내가 쓴 글</AccountDetailText>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ flexDirection: "row", alignItems: "center" }}
                    onPress={() => {this.navigateMyPost()}}
                >
                  <Image
                      style={{
                        width: widthPercentageToDP(28),
              ...
              >
                <TouchableOpacity onPress={() => {this.navigateMyScrap()}}>
                  <AccountDetailText>내가 스크랩한 글</AccountDetailText>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ flexDirection: "row", alignItems: "center" }}
                    onPress={() => {this.navigateMyScrap()}}
                >
                  <Image
                      style={{
                        width: widthPercentageToDP(28),
              ...
              >
                <TouchableOpacity onPress={() => {this.navigateAccountInfo();}}>
                  <AccountDetailText>계정정보</AccountDetailText>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ flexDirection: "row", alignItems: "center" }}
                    onPress={() => {this.navigateAccountInfo();}}
                >
                  <Image
                      style={{
                        width: widthPercentageToDP(28),
