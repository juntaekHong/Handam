...
import {View, Text, TouchableOpacity, Image, StyleSheet, Platform, ScrollView, SafeAreaView, FlatList} from 'react-native';
...
class MyPostListScreen extends React.Component {
    ...
    constructor(props) {
        ...
        didBlurSubscription = this.props.navigation.addListener(
            ...
            async payload => {
                ...
                await MyInfoActions.pageListPostsByUserIndex(this.props.orderby, this.props.postsList.length / 7, 7);
    ...
    pageListPosts = async () => {
        ...
        await MyInfoActions.pageListPostsByUserIndex(this.props.orderby, this.props.postsList.length / 7 + 1, 7);
            ...
            <SafeAreaView style={styles.container}>
                    {
                        this.props.myPost_loading == true ?
                            ...
                            <FlatList
                                ...
                                onEndReached={() => {this.props.postsList.length < this.props.total ? this.pageListPosts() : null;}}
