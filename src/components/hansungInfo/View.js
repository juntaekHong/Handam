...
export const ProgressView = styled.View`
  ...
  paddingTop: ${widthPercentageToDP(17)};
`;
...
export const PointListItem = props => {
    if(props.index % 2 == 0) {
        return (
            <View style={{position: "relative", left: widthPercentageToDP(0), flexDirection: "row", marginHorizontal: widthPercentageToDP(20), marginBottom: widthPercentageToDP(19)}}>
                <ImageBackground style={{flexDirection: "column", width: widthPercentageToDP(153), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_993.png")}>
                    <View>
        ...
        return (
            <View style={{position: "absolute",bottom: widthPercentageToDP(0), left: widthPercentageToDP(203), width: widthPercentageToDP(153), height: widthPercentageToDP(78), flexDirection: "row", marginLeft: widthPercentageToDP(4), marginBottom: widthPercentageToDP(19)}}>
        ...
        return (
            <View style={{
                ...
                <ImageBackground
                    style={{flexDirection: "column", width: widthPercentageToDP(153), height: widthPercentageToDP(78)}}
...
export const HansungPointMainView = props => {
    return (
        <ImageBackground style={{marginTop: widthPercentageToDP(29), backgroundColor: '#ffffff', width: widthPercentageToDP(345), height: widthPercentageToDP(139)}} source={require("../../../assets/image/hansungInfo/square_1275.png")} >
            <SimpleView>
                <BlockView>
    ...
    return (
        <Wrap>
            <RowBlockView style={{marginTop: widthPercentageToDP(30)}}>
                <ImageBackground style={{width: widthPercentageToDP(153), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_1026.png")}>
                    <WithInView>
                        <HansungPointValue>{props.carryOverPoint}</HansungPointValue>
                        <HansungPointProperty style={{marginTop: widthPercentageToDP(10), fontSize: widthPercentageToDP(11)}}>다음학기 이월예정 포인트</HansungPointProperty>
                    </WithInView>
                </ImageBackground>
                <ImageBackground style={{marginLeft: widthPercentageToDP(37), width: widthPercentageToDP(154), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_1026.png")}>
                    <WithInView>
                        <HansungPointValue>{props.currentSemesterPoint}</HansungPointValue>
                        <HansungPointProperty style={{marginTop: widthPercentageToDP(10), fontSize: widthPercentageToDP(11)}}>{props.currentSemester}학기 포인트</HansungPointProperty>
                    </WithInView>
                </ImageBackground>
            </RowBlockView>
            <RowBlockView>
                <ImageBackground style={{width: widthPercentageToDP(154), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_1026.png")}>
                    <WithInView>
                        <HansungPointValue>{props.departmentAverage}</HansungPointValue>
                        <HansungPointProperty style={{marginTop: widthPercentageToDP(10), fontSize: widthPercentageToDP(11)}}>학과 평균</HansungPointProperty>
                    </WithInView>
                </ImageBackground>
                <ImageBackground style={{marginLeft: widthPercentageToDP(37), width: widthPercentageToDP(154), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_1026.png")}>
                    <WithInView>
                        <HansungPointValue>{props.departmentMaximum}</HansungPointValue>
                        <HansungPointProperty style={{marginTop: widthPercentageToDP(10), fontSize: widthPercentageToDP(11)}}>학과 최대</HansungPointProperty>
                    </WithInView>
                </ImageBackground>
            </RowBlockView>
            <RowBlockView>
                <ImageBackground style={{width: widthPercentageToDP(154), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_1026.png")}>
                    <WithInView>
                        ...
                        <HansungPointProperty style={{marginTop: widthPercentageToDP(10), fontSize: widthPercentageToDP(11)}}>학년 평균</HansungPointProperty>
                    </WithInView>
                </ImageBackground>
                <ImageBackground style={{marginLeft: widthPercentageToDP(37), width: widthPercentageToDP(154), height: widthPercentageToDP(78)}} source={require("../../../assets/image/hansungInfo/square_1026.png")}>
                    <WithInView>
                        <HansungPointValue>{props.gradeMaximum}</HansungPointValue>
                        <HansungPointProperty style={{marginTop: widthPercentageToDP(10), fontSize: widthPercentageToDP(11)}}>학년 최대</HansungPointProperty>
                    </WithInView>
                </ImageBackground>
            </RowBlockView>
        </Wrap>
...
export const GradeSubView = props => {
    return(
        <ImageBackground style={{backgroundColor: '#ffffff', width: widthPercentageToDP(345), height: widthPercentageToDP(220)}} source={require("../../../assets/image/hansungInfo/square_1061.png")} >
            <GradeSimpleView style={{marginTop: widthPercentageToDP(-4)}}>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.requiredAccomplishments}</GradeValue>
                    <GradeProperty>교필</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(38)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.foundationAccomplishments}</GradeValue>
                    <GradeProperty>토대</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(37)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.hansungHumanResources}</GradeValue>
            ...
            <GradeSimpleView style={{marginTop: widthPercentageToDP(10)}}>
                ...
                <BlockView style={{paddingLeft: widthPercentageToDP(38)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.knowledge}</GradeValue>
            ...
            <GradeSimpleView style={{marginTop: widthPercentageToDP(10)}}>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.generalSelection}</GradeValue>
...
export const MajorUnitView = props => {
    return(
        <ImageBackground style={{backgroundColor: '#ffffff', width: widthPercentageToDP(345), height: widthPercentageToDP(74)}} source={require("../../../assets/image/hansungInfo/square_1296.png")} >
            <GradeSimpleView style={{marginTop: widthPercentageToDP(-4)}}>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.foundationMajor}</GradeValue>
                    <GradeProperty style={{width: widthPercentageToDP(82), height: widthPercentageToDP(16), fontSize: widthPercentageToDP(13)}}>전기(트랙1,2)</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(30)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.requiredMajor}</GradeValue>
                    <GradeProperty style={{width: widthPercentageToDP(82), height: widthPercentageToDP(16), fontSize: widthPercentageToDP(13)}}>전지(트랙1,2)</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(29)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.optionalMajor}</GradeValue>
                    <GradeProperty style={{width: widthPercentageToDP(82), height: widthPercentageToDP(16), fontSize: widthPercentageToDP(13)}}>전선(트랙1,2)</GradeProperty>
                </BlockView>
            </GradeSimpleView>
        </ImageBackground>
    )
...
export const TeachingUnitView = props => {
    return(
        <ImageBackground style={{backgroundColor: '#ffffff', width: widthPercentageToDP(228), height: widthPercentageToDP(74)}} source={require("../../../assets/image/hansungInfo/square_1301.png")} >
            <GradeSimpleView>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.requiredTeaching}</GradeValue>
                    <GradeProperty>교직</GradeProperty>
                </BlockView>
                <BlockView style={{marginLeft: widthPercentageToDP(38)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.optionalTeaching}</GradeValue>
...
export const MinorUnitView = props => {
    return(
        <ImageBackground style={{backgroundColor: '#ffffff', width: widthPercentageToDP(345), height: widthPercentageToDP(74)}} source={require("../../../assets/image/hansungInfo/square_1296.png")} >
            <GradeSimpleView style={{marginTop: widthPercentageToDP(-4)}}>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.foundationMinor}</GradeValue>
                    <GradeProperty>부전기</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(38)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.requiredMinor}</GradeValue>
                    <GradeProperty>부전지</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(37)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.optionalMinor}</GradeValue>
...
export const DoubleMajorUnitView = props => {
    return(
        <ImageBackground style={{backgroundColor: '#ffffff', width: widthPercentageToDP(345), height: widthPercentageToDP(74)}} source={require("../../../assets/image/hansungInfo/square_1296.png")} >
            <GradeSimpleView style={{marginTop: widthPercentageToDP(-4)}}>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.foundationDoubleMajor}</GradeValue>
                    <GradeProperty>복전기</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(38)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.requiredDoubleMajor}</GradeValue>
                    <GradeProperty>복전지</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(37)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.optionalDoubleMajor}</GradeValue>
...
export const ConnectedMajorUnitView = props => {
    return(
        <ImageBackground style={{backgroundColor: '#ffffff', width: widthPercentageToDP(345), height: widthPercentageToDP(74)}} source={require("../../../assets/image/hansungInfo/square_1296.png")} >
            <GradeSimpleView style={{marginTop: widthPercentageToDP(-4)}}>
                <BlockView>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.foundationConnectedMajor}</GradeValue>
                    <GradeProperty>연전기</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(38)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.requiredConnectedMajor}</GradeValue>
                    <GradeProperty>연전지</GradeProperty>
                </BlockView>
                <BlockView style={{paddingLeft: widthPercentageToDP(37)}}>
                    <GradeValue style={{color: '#2e2e2e'}}>{props.optionalConnectedMajor}</GradeValue>
